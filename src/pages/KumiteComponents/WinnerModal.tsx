        ...
        <ModalBody className="py-10">
          <div className="flex flex-col items-center gap-6">
            <motion.h2
              ...
              className={`text-4xl font-extrabold text-center ${side === "aka" ? "text-red-600" : "text-blue-900 dark:text-blue-400"}`}
            >
              {winnerName}
            </motion.h2>
            ...
            >
              <div className="flex flex-col items-center">
                ...
                <span
                  className={`text-5xl font-black ${side === "aka" ? "text-red-600" : "text-gray-400"}`}
                >
                  {scoreAka}
                </span>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <span
                  className={`text-5xl font-black ${side === "shiro" ? "text-blue-900 dark:text-blue-400 font-bold" : "text-gray-400"}`}
                >
                  {scoreShiro}
                </span>
              </div>
